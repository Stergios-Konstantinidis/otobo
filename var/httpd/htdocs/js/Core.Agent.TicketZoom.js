...
Core.Agent.TicketZoom = (function (TargetNS) {
    ...
    /**
    * @public
    * @name copyTitleToClipboard
    * @memberof Core.Agent.TicketZoom
    * @function
    * @description
    *      This function interacts with the clickable button on the ticket zoom page
    *      It allows to efficiently copy the item on display with the hyperlink of the page.
    */
